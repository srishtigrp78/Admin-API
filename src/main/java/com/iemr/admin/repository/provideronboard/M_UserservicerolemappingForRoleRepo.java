...
public interface M_UserservicerolemappingForRoleRepo extends CrudRepository<M_UserservicerolemappingForRole, Integer>{
	...
	@Query("SELECT u FROM M_UserservicerolemappingForRole u WHERE u.uSRMappingID=:uSRMappingID")
	M_UserservicerolemappingForRole findByUSRMappingID(Integer uSRMappingID);
