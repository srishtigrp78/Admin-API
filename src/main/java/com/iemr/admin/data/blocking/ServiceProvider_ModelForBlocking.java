...
public class ServiceProvider_ModelForBlocking
{
	@Id
	...
	@OneToOne(mappedBy="serviceProvider_ModelForBlocking")
	private M_Providerservicemapping_Blocking m_Providerservicemapping_Blocking;

	public ServiceProvider_ModelForBlocking()
	{

	}

	public ServiceProvider_ModelForBlocking(Integer serviceProviderId, String serviceProviderName, Date joiningDate,
			...
			String secondaryContactEmailID, String secondaryContactAddress, Timestamp secondaryContactValidityTillDate,
			Boolean deleted, String createdBy, Timestamp validFrom, Timestamp validTill, Timestamp createdDate, String modifiedBy,
